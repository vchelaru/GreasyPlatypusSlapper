...
{
    public partial class Smoke : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable
    {
        ...
        public Smoke (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Smoke (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("SmokeStaticUnload", UnloadStaticContent);
